...
#         images = (self.max - self.min) * (images - min_val) / (max_val - min_val) + self.min
        images = (self.max - self.min) * (images) / (self._data_max - self._data_min) + self.min
        ########################################################################
        #                           END OF YOUR CODE                           #
        ########################################################################
        return images
